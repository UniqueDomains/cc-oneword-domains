...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-5%2C804%20rows-8250df">
...
**Public extract:** 5,804 rows · **Live catalog:** 5,802 domains
...
- `cc.csv` — public CSV extract (5,804 rows)
- `cc.json` — public JSON extract (5,804 rows)
...
| ----------------------- | ------------------------------------------------ |
| 5,804-row public sample | 5,802 live domains                               |
