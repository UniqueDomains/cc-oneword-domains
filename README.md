# Available .CC One-Word Domains (8,108)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-8%2C108%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **8,108 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 8,108 domains · **Median ask:** $6.75 · **High-demand under $2,500:** 1
...
| xcvii.cc   | available | $4.19     | $9.99         | low            | low    | 5      | namesilo              |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 8,108 live domains                         |
...
> Unique Domains. *Available .CC One-Word Domains*. Version 2026-08-06. Public GitHub extract for the exact Unique Domains search represented by this repository.
