# Available .CC One-Word Domains (5,799)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-5%2C794%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-5%2C799%20domains-6f42c1">
...
> **Important:** this repository is a **public 5,794-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,799 domains** on the canonical page below.

**Public extract:** 5,794 rows · **Live catalog:** 5,799 domains
...
- `cc.csv` — public CSV extract (5,794 rows)
- `cc.json` — public JSON extract (5,794 rows)
...
| ------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | -------------------------- |
| terrible.cc   | available | $13.98    | —             | 68             | 22     | 8      | namecheap                  |
| france.cc     | resell    | —         | —             | 76             | 99     | 6      | Dynadot Inc                |
| addicted.cc   | premium   | $13.98    | —             | 72             | 12     | 8      | namecheap                  |
| masterly.cc   | available | $13.98    | —             | 79             | 18     | 8      | namecheap                  |
| smart.cc      | resell    | —         | —             | 74             | 99     | 5      | eName Technology Co., Ltd. |
| adapted.cc    | premium   | $13.98    | —             | 74             | 9      | 7      | namecheap                  |
| burning.cc    | available | $35       | —             | 72             | 18     | 7      | name.com                   |
| indian.cc     | resell    | —         | —             | 86             | 98     | 6      | 22net, Inc.                |
| invigorate.cc | premium   | —         | —             | 78             | 98     | 10     | —                          |
| foolish.cc    | available | $13.98    | —             | 60             | 15     | 7      | namecheap                  |
| fearless.cc   | resell    | —         | —             | 72             | 98     | 8      | Dynadot Inc                |
| parody.cc     | premium   | —         | —             | 92             | 97     | 6      | —                          |
| moveon.cc     | available | $13.98    | —             | 72             | 14     | 7      | namecheap                  |
| germany.cc    | resell    | —         | —             | 70             | 98     | 7      | InterNetX GmbH             |
| deceased.cc   | premium   | —         | —             | 64             | 97     | 8      | —                          |
| prepared.cc   | available | $13.98    | —             | 66             | 14     | 8      | namecheap                  |
| shed.cc       | resell    | —         | —             | 62             | 98     | 4      | Unstoppable Domains Inc.   |
| tylenol.cc    | premium   | —         | —             | 78             | 59     | 7      | —                          |
| alamode.cc    | available | $13.98    | —             | 96             | 13     | 9      | namecheap                  |
| romantic.cc   | resell    | —         | —             | 74             | 97     | 8      | Porkbun LLC                |
...
| ----------------------- | ------------------------------------------------ |
| 5,794-row public sample | 5,799 live domains                               |
...
> Unique Domains. *Available .CC One-Word Domains*. Version 2026-04-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
