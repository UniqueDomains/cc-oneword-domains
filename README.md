...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-5%2C803%20rows-8250df">
...
**Public extract:** 5,803 rows · **Live catalog:** 5,802 domains
...
- `cc.csv` — public CSV extract (5,803 rows)
- `cc.json` — public JSON extract (5,803 rows)
...
| ------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | -------------------------- |
| terrible.cc   | available | $13.98    | —             | 68             | 23     | 8      | namecheap                  |
...
| ----------------------- | ------------------------------------------------ |
| 5,803-row public sample | 5,802 live domains                               |
...
> Unique Domains. *Available .CC One-Word Domains*. Version 2026-04-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
